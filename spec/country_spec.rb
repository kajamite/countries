...
describe ISO3166AtWork::Country do
  let(:country) { ISO3166AtWork::Country.search('US') }
  ...
  it 'knows when a country does not require postal codes' do
    ireland = ISO3166AtWork::Country.search('IE')
  ...
  context 'with Turkey' do
    let(:country) { ISO3166AtWork::Country.search('TR') }
  ...
  context 'with Japan' do
    let(:country) { ISO3166AtWork::Country.search('JP') }
  ...
  context 'with Belgium' do
    let(:country) { ISO3166AtWork::Country.search('BE') }
  ...
  it 'should be identical to itself' do
    expect(country).to eq(ISO3166AtWork::Country.search('US'))
  end
  ...
  describe 'subdivisions' do
    it 'should return an empty hash for a country with no ISO3166-2' do
      expect(ISO3166AtWork::Country.search('VA').subdivisions.size).to eq(0)
    end
  ...
  describe 'valid?' do
    it 'should return true if country is valid' do
      expect(ISO3166AtWork::Country.new('US')).to be_valid
    end

    it 'should return false if country is invalid' do
      expect(ISO3166AtWork::Country.new({})).not_to be_valid
    end
  end

  describe 'new' do
    it 'should return new country object when a valid alpha2 string is passed' do
      expect(ISO3166AtWork::Country.new('US')).to be_a(ISO3166AtWork::Country)
    end

    it 'should return nil when an invalid alpha2 string is passed' do
      expect(ISO3166AtWork::Country.new('fubar')).to be_nil
    end
  ...
  describe 'compare' do
    it 'should compare itself with other countries by its name' do
      canada = ISO3166AtWork::Country.search('CA')
      mexico = ISO3166AtWork::Country.search('MX')
  ...
  describe 'all' do
    it 'should return an array list of all countries' do
      countries = ISO3166AtWork::Country.all
      expect(countries).to be_an(Array)
      expect(countries.first).to be_an(ISO3166AtWork::Country)
      expect(countries.size).to eq(250)
    end

    it 'should allow to customize each country representation passing a block to the method' do
      countries = ISO3166AtWork::Country.all { |country, data| [data['name'], country, data['country_code']] }
      expect(countries).to be_an(Array)
  ...
  describe 'all_translated' do
    it 'should return an alphabetized list of all country names translated to the selected locale' do
      countries = ISO3166AtWork::Country.all_translated('fr')
      expect(countries).to be_an(Array)
    ...
    it 'should return an alphabetized list of all country names in English if no locale is passed' do
      countries = ISO3166AtWork::Country.all_translated
      expect(countries).to be_an(Array)
      expect(countries.first).to be_a(String)
      expect(countries.first).to eq('Afghanistan')
      expect(countries.size).to eq(249)
  ...
  describe 'all_names_with_codes' do
    ...
    it 'should return an alphabetized list of all country names with ISOCODE alpha2' do
      countries = ISO3166AtWork::Country.all_names_with_codes
      expect(countries).to be_an(Array)
  ...
  describe 'translation' do
    it 'should return the localized name for a country to the selected locale' do
      countries = ISO3166AtWork::Country.new(:de).translation('de')
    ...
    it 'should return the localized name for a country in English' do
      countries = ISO3166AtWork::Country.new(:de).translation
      expect(countries).to be_an(String)
      expect(countries).to eq('Germany')
    end

    it 'should return nil when a translation is not found' do
      countries = ISO3166AtWork::Country.new(:de).translation('xxx')
  ...
  describe 'translations' do
    it 'should return an hash of all country names translated to the selected locale' do
      countries = ISO3166AtWork::Country.translations('fr')
    ...
    it 'should return an hash of all country names in English if no locale is passed' do
      countries = ISO3166AtWork::Country.translations
      expect(countries).to be_an(Hash)
      expect(countries.first[0]).to eq('AF')
      expect(countries.first).to eq(%w(AF Afghanistan))
      expect(countries.size).to eq(249)
  ...
  describe 'countries' do
    it 'should be the same as all' do
      expect(ISO3166AtWork::Country.countries).to eq(ISO3166AtWork::Country.all)
    end
  end

  describe 'search' do
    it 'should return new country object when a valid alpha2 string is passed' do
      expect(ISO3166AtWork::Country.search('US')).to be_a(ISO3166AtWork::Country)
    end

    it 'should return nil when an invalid alpha2 string is passed' do
      expect(ISO3166AtWork::Country.search('fubar')).to be_nil
    end
  ...
  describe 'Country class' do
    ...
    context "when loaded via 'global'" do
      ...
      describe 'superclass' do
        subject { CountryAtWork.superclass }

        it { is_expected.to eq(ISO3166AtWork::Country) }
      end

      describe 'to_s' do
        it 'should return the country name' do
          expect(CountryAtWork.new('GB').to_s).to eq('United Kingdom')
        end
      end
    end
  end
  ...
  describe 'codes' do
    it 'returns a hash with the data of the country' do
      expect(ISO3166AtWork::Country.codes).to be_a Array
      expect(ISO3166AtWork::Country.codes.size).to eq(250)
    end
  end

  describe 'find_all_by' do
    context 'when searchead attribute equals the given value' do
      let(:spain_data) { ISO3166AtWork::Country.find_all_by('alpha2', 'ES') }
    ...
    context 'when searchead attribute is list and one of its elements equals the given value' do
      let(:spain_data) { ISO3166AtWork::Country.find_all_by('languages', 'en') }
    ...
    it 'also finds results if the given values is not upcased/downcased properly' do
      spain_data = ISO3166AtWork::Country.find_all_by('alpha2', 'es')
      expect(spain_data).to be_a Hash
      expect(spain_data.keys.size).to eq(1)
    end
    ...
    it 'casts the given value to a string to perform the search' do
      spain_data = ISO3166AtWork::Country.find_all_by(:country_code, 34)
      expect(spain_data).to be_a Hash
      expect(spain_data.keys).to eq(['ES'])
    end

    it 'also performs searches with regexps and forces it to ignore case' do
      spain_data = ISO3166AtWork::Country.find_all_by(:names, /Españ/)
      expect(spain_data).to be_a Hash
      expect(spain_data.keys).to eq(['ES'])
    end
  end
  ...
  describe 'hash finder methods' do
    context "when search name in 'name'" do
      subject { ISO3166AtWork::Country.find_by_name('Poland') }
      it 'should return' do
    ...
    context "when search name in 'names'" do
      subject { ISO3166AtWork::Country.find_by_name('Polonia') }
      it 'should return' do
        expect(subject.first).to eq('PL')
      end
    end
    ...
    context 'when finding by invalid attribute' do
      it 'should raise an error' do
        expect { ISO3166AtWork::Country.find_by_invalid('invalid') }.to raise_error(RuntimeError, "Invalid attribute name 'invalid'")
      end
    end

    context 'when using find_all method' do
      let(:list) { ISO3166AtWork::Country.find_all_by_currency('USD') }
    ...
    context 'when using find_by method' do
      subject { ISO3166AtWork::Country.find_by_alpha3('CAN') }
      it 'should return' do
  ...
  describe 'country finder methods' do
    context 'when search name found' do
      let(:uk) { ISO3166AtWork::Country.find_country_by_name('United Kingdom') }

      it 'should be a country instance' do
        expect(uk).to be_a(ISO3166AtWork::Country)
    ...
    context 'when search translation found' do
      let(:uk) { ISO3166AtWork::Country.find_country_by_translated_names('Velika Britanija') }
    ...
    context 'when search name not found' do
      let(:bogus) { ISO3166AtWork::Country.find_country_by_name('Does not exist') }
    ...
    # Spot checks #243
    context 'when search name not found' do
      let(:belgium) { ISO3166AtWork::Country.find_country_by_name('Belgium') }
    ...
    # Spot checks #240
    context 'when search name not found' do
      let(:canada) { ISO3166AtWork::Country.find_country_by_name('Canada') }
    ...
    # Spot checks #241
    context 'when search name not found' do
      let(:israel) { ISO3166AtWork::Country.find_country_by_name('Israel') }
    ...
    # Spot checks #241
    context 'when search name not found' do
      let(:israel) { ISO3166AtWork::Country.find_by_name('Israel') }
    ...
    # Spot checks #241
    context 'when search name not found' do
      let(:israel) { ISO3166AtWork::Country.find_all_by(:name, 'Israel') }
    ...
    context 'when finding by invalid attribute' do
      it 'should raise an error' do
        expect { ISO3166AtWork::Country.find_country_by_invalid('invalid') }.to raise_error(RuntimeError,
                                                                                            "Invalid attribute name 'invalid'")
      end
    end

    context 'when using find_all method' do
      let(:list) { ISO3166AtWork::Country.find_all_countries_by_currency('USD') }

      it 'should be an Array of Country objects' do
        expect(list).to be_a(Array)
        expect(list.first).to be_a(ISO3166AtWork::Country)
      end
    end

    context 'when using find_by method' do
      let(:country) { ISO3166AtWork::Country.find_country_by_alpha3('CAN') }

      it 'should be a single country object' do
        expect(country).to be_a(ISO3166AtWork::Country)
      end
    end
  end
  ...
  describe 'names in Data' do
    it 'should be unique (to allow .find_by_name work properly)' do
      names = ISO3166AtWork::Country::Setup.data.map do |_k, v|
  ...
  describe 'Norway' do
    let(:norway) { ISO3166AtWork::Country.search('NO') }
  ...
  describe 'Guernsey' do
    let(:guernsey) { ISO3166AtWork::Country.search('GG') }
  ...
  describe 'Languages' do
    let(:german_speaking_countries) { ISO3166AtWork::Country.find_all_countries_by_languages('de') }
  ...
  describe 'in_eu?' do
    let(:netherlands) { ISO3166AtWork::Country.search('NL') }
  ...
  describe 'gec' do
    it 'should return the country\'s GEC code' do
      expect(ISO3166AtWork::Country.new('NA').gec).to eql 'WA'
    end

    it 'should return nil if the country does not have a GEC code' do
      expect(ISO3166AtWork::Country.new('AN').gec).to eql nil
    end
  end

  describe 'to_s' do
    it 'should return the country name' do
      expect(ISO3166AtWork::Country.new('GB').to_s).to eq('United Kingdom')
    end
  end

  describe 'VAT rates' do
    let(:belgium) { ISO3166AtWork::Country.search('BE') }
  ...
  describe 'ISO3166::Country()' do
    it 'should return same object if instance of ISO3166::Country given' do
      expect(ISO3166AtWork::Country(country)).to eq country
    end

    it 'should return country if instance of String given' do
      expect(ISO3166AtWork::Country('us')).to eq country
    end

    it 'should return country if not convertable input given' do
      expect do
        ISO3166AtWork::Country(42)
